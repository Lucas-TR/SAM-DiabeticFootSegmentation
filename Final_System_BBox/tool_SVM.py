...
def prediction_SVM_predict(path_out_origin, path_out, path_img,n_segment, compactness, sigma, threshold , layer, name_image, method):
    ...
    for i in range(n_iter):
        ...
        #Path_model = '{}/{}'.format(path_out_origin,'Predictions')
        new_file(path_out_origin, file_visual_prediction, 0)
            
        create_img_final(img, segments_slic, clas, name_image[i], file_visual_prediction)
