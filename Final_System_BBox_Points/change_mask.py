...
# Uso de la función:
ruta_etiquetas = r'C:\Users\nicol\OneDrive\Escritorio\mask_ref\mask_arc_ext'
ruta_predicciones_bbox_points = r'C:\Users\nicol\OneDrive\Escritorio\pre_arc_ext'


ruta_predicciones_bbox = r'D:\Project_lesiones\Pruebas_SAM_paper\segment-anything-main\predict_ones_MedSAM'


df_resultados= calcular_metricas(ruta_etiquetas, ruta_predicciones_bbox_points)


df_resultados2 = calcular_metricas(ruta_etiquetas, ruta_predicciones_bbox)
...
df_top_iou2.to_excel('results_medSAM.xlsx', index=False)
